...
import { BiArrowFromRight, BiArrowToRight, BiSolidArrowFromRight, BiSolidArrowToRight } from "react-icons/bi";
import { FaAndroid, FaChartPie, FaCode, FaSearch, FaShieldAlt } from "react-icons/fa";
        ...
        <div className="container py-5">
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
              <div className="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                <div className="service-icon">
                  <FaAndroid className="text-white" />
                </div>
